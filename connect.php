<?php
    ...
    try {
        $conn = new PDO("sqlsrv:server = tcp:saheli-data-server.database.windows.net,1433; Database = sphotodata", "azure", "Saheli@111");
    ...
    $connectionInfo = array("UID" => "azure", "pwd" => "Saheli@111", "Database" => "sphotodata", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
    $serverName = "tcp:saheli-data-server.database.windows.net,1433";
